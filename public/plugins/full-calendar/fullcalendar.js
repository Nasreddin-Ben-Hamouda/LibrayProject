...
function getClientRect(el, origin) {
    ...
    return {
        ...
        top: top,
        bottom: top + el[0].clientHeight // clientHeight inc padding but NOT scrollbars
    };
}
...
var View = /** @class */ (function (_super) {
    ...
    function View(calendar, viewSpec) {
        ...
        _this.isSelected = false; // boolean whether a range of time is home-selected or not
        _this.calendar = calendar;
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.queryToolbarsHeight = function () {
        return this.toolbarsManager.items.reduce(function (accumulator, toolbar) {
            var toolbarHeight = toolbar.el ? toolbar.el.outerHeight(true) : 0; // inc margin
